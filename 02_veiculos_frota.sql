CREATE TABLE
    veiculo (
        ...
        status_operacional ENUM ('Ativo', 'Em manutenção', 'Reserva', 'Desativado') DEFAULT 'Ativo',
        data_aquisicao DATE,
...
CREATE TABLE
    garagem (
        ...
        tipo_garagem ENUM ('Urbana', 'Rodoviária', 'Ferroviária', 'Mista') NOT NULL,
...
CREATE TABLE
    manutencao (
        ...
        tipo_manutencao ENUM ('Preventiva', 'Corretiva', 'Revisão', 'Inspeção') NOT NULL,
...
CREATE TABLE
    posto_abastecimento (
        ...
        endereco_id INT,
        cnpj VARCHAR(18),
        tipo_posto ENUM ('Interno', 'Conveniado', 'Público') NOT NULL,
...
CREATE TABLE
    pneu (
        ...
        tipo ENUM ('Radial', 'Diagonal', 'Sem câmara', 'Com câmara') NOT NULL,
